...
export const projects: Project[] = [
  ...
  },
  {
    ...
    endDate: formatInputDate(new Date("2024-10-15")),
    complete: false,
    collaborators: [
      { username: "Alice" },
      { username: "Bob" },
  ...
  },
  {
    ...
    endDate: formatInputDate(new Date("2024-09-20")),
    complete: false,
    collaborators: [
      { username: "Dave" },
      { username: "Eve" },
  ...
  },
  {
    ...
    endDate: formatInputDate(new Date("2025-01-31")),
    complete: false,
    collaborators: [
      { username: "Grace" },
      { username: "Heidi" },
  ...
  },
  {
    ...
    endDate: formatInputDate(new Date("2024-11-30")),
    complete: false,
    collaborators: [
      { username: "Jack" },
      { username: "Kathy" },
